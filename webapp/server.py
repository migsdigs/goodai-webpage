...
async def websocket_handler(request: Request) -> WebSocketResponse:
    ...
    async for msg in ws:
        if msg.type == WSMsgType.TEXT:
            ...
            frequency = await update_frequency(msg=msg, frequency=frequency)
...
async def update_frequency(msg: WSMsgType.TEXT, frequency: int) -> int:
    """
